...
# The "relations_sorted.csv" should already be sorted based on day and time_ms using the Linux sort command:
...
previousDst = '0'
previousRelation = '0'
with open(dataFolder+'relations_sorted.csv','r') as f:
    for line in f:
        lineVal = line.rstrip('\n').split('\t')
